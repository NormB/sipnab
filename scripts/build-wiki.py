...
PAGES: dict[str, str] = {
    ...
    "vcon.md": "vCon-Export",
    "vcon-harness.md": "vCon-Capture-Stack",
    "vcon-server.md": "Add-a-vCon-Server",
    "vcon-sipnab.md": "Send-vCons-to-a-vCon-Server",
    "tfps.md": "Add-TFPS",
    "tfps-sipnab.md": "Control-TFPS-from-sipnab",
    "rtpengine-relay.md": "Add-rtpengine",
    "rtpengine-sipnab.md": "Name-rtpengine-Media-with-sipnab",
    "homer.md": "Add-Homer",
    "homer-sipnab.md": "Connect-sipnab-to-Homer",
    ...
    "sip-response-codes.md": "SIP-Response-Codes",
    "sip-methods.md": "SIP-Methods",
    "sip-header-fields.md": "SIP-Header-Fields",
    "sip-parameters.md": "SIP-Parameters",
    "sip-lint-rules.md": "SIP-Lint-Rules",
    "mos-and-codecs.md": "MOS-and-Codecs",
    "config-reference.md": "Configuration",
    "rest-api.md": "REST-API",
    "prometheus-metrics.md": "Prometheus-Metrics",
    "mcp.md": "MCP",
    "uprobe-walkthrough.md": "Uprobe-Walkthrough",
    "mcp-deploy.md": "MCP-Deployment",
    "mcp-estate.md": "MCP-Across-an-Estate",
    "mcp-tools.md": "MCP-Tools",
    "mcp-protocol.md": "MCP-Protocol",
    "auth.md": "Authentication",
    "library.md": "Library-API",
    "tls-capture.md": "Capture-SIP-over-TLS",
    "plugins.md": "WASM-Plugins",
...
GROUPS: list[tuple[str, list[str]]] = [
    ...
    ("Integrations (API & MCP)", ["rest-api.md", "prometheus-metrics.md", "auth.md", "mcp.md",
                                  ...
                                  "vcon.md", "vcon-harness.md"]),
    ("Add to your voice stack", ["vcon-server.md", "vcon-sipnab.md", "tfps.md", "tfps-sipnab.md",
                                 "rtpengine-relay.md", "rtpengine-sipnab.md",
                                 "homer.md", "homer-sipnab.md"]),
