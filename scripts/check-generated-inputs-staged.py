...
DERIVED = {
    ...
    # The OpenAPI document is generated by tests/openapi_contract_test.rs from
    # the #[utoipa::path] annotations plus the shared JSON Schemas. Staging it
    # while any of the three sits unstaged publishes a contract describing the
    # working tree rather than the commit -- and this artifact is served to
    # clients, so a wrong one is worse than a stale doc page.
    "website/static/openapi.json": (
        "src/output/api.rs",
        "tests/schemas/",
        "tests/openapi_contract_test.rs",
    ),
