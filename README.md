...
- **MCP server mode** -- expose analysis (dialogs, streams, RTP, security findings) as 65 Model Context Protocol tools an AI agent can call. No tool edits the analysis in place; file export, capture swapping and shutdown stay off unless you enable them. Stdio + HTTP transports. See [`docs/mcp.md`](./docs/mcp.md).
