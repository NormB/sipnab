...
|---|---|---|---|
| Canonical | [`src/pipeline.rs:2445`](https://github.com/NormB/sipnab/blob/main/src/pipeline.rs#L2445) `process_packet` | 142 ln | TUI live |
...
| MCP | [`src/mcp/server.rs:9077`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L9077) `DialogSummary` | **`message_count`**, **`format!("{:?}", method)`** |
