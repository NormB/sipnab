...
| Batch | [`src/app/batch.rs:2840`](https://github.com/NormB/sipnab/blob/main/src/app/batch.rs#L2840) `process_parsed_packet` | 402 ln | batch mode |
...
| Surface | Site | Drift |
|---|---|---|
| CLI/NDJSON | [`src/output/json.rs:363`](https://github.com/NormB/sipnab/blob/main/src/output/json.rs#L363) `DialogJson` | `msg_count`, `schema_version: 1` |
