...
([`server.rs:6280`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6280)) writes a pcap, `export_audio`
([`server.rs:6333`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6333)) writes a WAV, `list_captures`
([`server.rs:6211`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6211)) reads a directory, and
`shutdown_server` ([`server.rs:6798`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6798)) ends the process.
...
1. **Off unless armed.** `allow_shutdown: bool`
   ...
   ([`server.rs:443`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L443)) and only set by `with_shutdown()`
   ([`server.rs:443`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L443)), which `servers.rs` calls only
...
- `DialogSummary.from_user` / `to_user`
  ...
  From/To URIs.
- `get_message` ([`server.rs:4087`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4087)) returns the parsed
  message through `message_to_json_value`, headers and body included.
- `search_messages` ([`server.rs:4379`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4379)) returns
  `snippet`, built as
...
([`server.rs:482`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L482)), or — only if armed, only on a
...
arbitrary-file-read"*. It shipped ([`server.rs:482`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L482))
with `--mcp-file-root` and `resolve_in_root`
([`server.rs:482`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L482)), which accepts a bare filename and
...
`capture_status` ([`server.rs:4727`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4727)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:4727`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4727)) naming the old file in the
...
([`server.rs:6798`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6798)), and `--mcp-file-root` with
`resolve_in_root` ([`server.rs:482`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L482)).
