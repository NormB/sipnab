...
([`server.rs:6859`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6859)) writes a pcap, `export_audio`
([`server.rs:6912`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6912)) writes a WAV, `list_captures`
([`server.rs:6790`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6790)) reads a directory, and
`shutdown_server` ([`server.rs:7351`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7351)) ends the process.
...
1. **Off unless armed.** `allow_shutdown: bool`
   ...
   ([`server.rs:594`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L594)) and only set by `with_shutdown()`
   ([`server.rs:594`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L594)), which `servers.rs` calls only
...
- `DialogSummary.from_user` / `to_user`
  ...
  From/To URIs.
- `get_message` ([`server.rs:4639`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4639)) returns the parsed
  message through `message_to_json_value`, headers and body included.
- `search_messages` ([`server.rs:4931`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4931)) returns
  `snippet`, built as
...
([`server.rs:641`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L641)), or — only if armed, only on a
...
arbitrary-file-read"*. It shipped ([`server.rs:641`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L641))
with `--mcp-file-root` and `resolve_in_root`
([`server.rs:641`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L641)), which accepts a bare filename and
...
`capture_status` ([`server.rs:5297`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5297)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:5297`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5297)) naming the old file in the
...
([`server.rs:7351`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7351)), and `--mcp-file-root` with
`resolve_in_root` ([`server.rs:641`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L641)).
