...
([`server.rs:6547`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6547)) writes a pcap, `export_audio`
([`server.rs:6600`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6600)) writes a WAV, `list_captures`
([`server.rs:6478`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6478)) reads a directory, and
`shutdown_server` ([`server.rs:7039`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7039)) ends the process.
...
1. **Off unless armed.** `allow_shutdown: bool`
   ...
   ([`server.rs:561`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L561)) and only set by `with_shutdown()`
   ([`server.rs:561`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L561)), which `servers.rs` calls only
...
- `DialogSummary.from_user` / `to_user`
  ...
  From/To URIs.
- `get_message` ([`server.rs:4305`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4305)) returns the parsed
  message through `message_to_json_value`, headers and body included.
- `search_messages` ([`server.rs:4597`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4597)) returns
  `snippet`, built as
...
([`server.rs:608`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L608)), or — only if armed, only on a
...
arbitrary-file-read"*. It shipped ([`server.rs:608`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L608))
with `--mcp-file-root` and `resolve_in_root`
([`server.rs:608`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L608)), which accepts a bare filename and
...
`capture_status` ([`server.rs:4963`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4963)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:4963`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4963)) naming the old file in the
...
([`server.rs:7039`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7039)), and `--mcp-file-root` with
`resolve_in_root` ([`server.rs:608`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L608)).
