...
([`server.rs:7387`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7387)) writes a pcap, `export_audio`
([`server.rs:7440`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7440)) writes a WAV, `list_captures`
([`server.rs:7171`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7171)) reads a directory, and
`shutdown_server` ([`server.rs:7913`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7913)) ends the process.
...
`capture_status` ([`server.rs:5665`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5665)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:5665`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5665)) naming the old file in the
...
([`server.rs:7913`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7913)), and `--mcp-file-root` with
