...
([`server.rs:6207`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6207)) writes a pcap, `export_audio`
([`server.rs:6260`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6260)) writes a WAV, `list_captures`
([`server.rs:6156`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6156)) reads a directory, and
`shutdown_server` ([`server.rs:6725`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6725)) ends the process.
...
- `DialogSummary.from_user` / `to_user`
  ...
  From/To URIs.
- `get_message` ([`server.rs:4014`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4014)) returns the parsed
  message through `message_to_json_value`, headers and body included.
- `search_messages` ([`server.rs:4306`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4306)) returns
  `snippet`, built as
...
`capture_status` ([`server.rs:4654`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4654)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:4654`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4654)) naming the old file in the
...
([`server.rs:6725`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6725)), and `--mcp-file-root` with
