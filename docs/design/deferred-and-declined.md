...
([`server.rs:5735`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5735)) writes a pcap, `export_audio`
([`server.rs:5783`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5783)) writes a WAV, `list_captures`
([`server.rs:5683`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5683)) reads a directory, and
`shutdown_server` ([`server.rs:6248`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6248)) ends the process.
...
- `DialogSummary.from_user` / `to_user`
  ...
  From/To URIs.
- `get_message` ([`server.rs:3563`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L3563)) returns the parsed
  message through `message_to_json_value`, headers and body included.
- `search_messages` ([`server.rs:3855`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L3855)) returns
  `snippet`, built as
...
`capture_status` ([`server.rs:4203`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4203)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:4203`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4203)) naming the old file in the
...
([`server.rs:6248`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6248)), and `--mcp-file-root` with
