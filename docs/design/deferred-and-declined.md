...
- `search_messages` ([`server.rs:5359`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5359)) returns
  `snippet`, built as
...
`capture_status` ([`server.rs:5729`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5729)) would keep naming
