...
`capture_status` ([`server.rs:5685`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5685)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:5685`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5685)) naming the old file in the
