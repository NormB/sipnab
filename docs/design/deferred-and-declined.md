...
([`server.rs:7093`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7093)) writes a pcap, `export_audio`
([`server.rs:7146`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7146)) writes a WAV, `list_captures`
([`server.rs:7024`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7024)) reads a directory, and
`shutdown_server` ([`server.rs:7626`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7626)) ends the process.
...
- `DialogSummary.from_user` / `to_user`
  ...
  From/To URIs.
- `get_message` ([`server.rs:4866`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4866)) returns the parsed
  message through `message_to_json_value`, headers and body included.
- `search_messages` ([`server.rs:5161`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5161)) returns
  `snippet`, built as
...
`capture_status` ([`server.rs:5531`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5531)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:5531`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5531)) naming the old file in the
...
([`server.rs:7626`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7626)), and `--mcp-file-root` with
