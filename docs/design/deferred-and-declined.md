...
([`server.rs:5950`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5950)) writes a pcap, `export_audio`
([`server.rs:5998`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5998)) writes a WAV, `list_captures`
([`server.rs:5898`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5898)) reads a directory, and
`shutdown_server` ([`server.rs:6463`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6463)) ends the process.
...
- `DialogSummary.from_user` / `to_user`
  ...
  From/To URIs.
- `get_message` ([`server.rs:3778`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L3778)) returns the parsed
  message through `message_to_json_value`, headers and body included.
- `search_messages` ([`server.rs:4070`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4070)) returns
  `snippet`, built as
...
`capture_status` ([`server.rs:4418`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4418)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:4418`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4418)) naming the old file in the
...
([`server.rs:6463`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6463)), and `--mcp-file-root` with
