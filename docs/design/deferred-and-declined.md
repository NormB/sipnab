...
([`server.rs:6858`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6858)) reads a directory, and
...
- `search_messages` ([`server.rs:4995`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4995)) returns
  `snippet`, built as
...
`capture_status` ([`server.rs:5365`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5365)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:5365`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5365)) naming the old file in the
