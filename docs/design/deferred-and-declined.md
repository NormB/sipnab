...
([`server.rs:7381`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7381)) writes a pcap, `export_audio`
([`server.rs:7434`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7434)) writes a WAV, `list_captures`
([`server.rs:7165`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7165)) reads a directory, and
`shutdown_server` ([`server.rs:7907`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7907)) ends the process.
...
- `DialogSummary.from_user` / `to_user`
  ...
  From/To URIs.
- `get_message` ([`server.rs:4901`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4901)) returns the parsed
...
- `search_messages` ([`server.rs:5315`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5315)) returns
  `snippet`, built as
...
`capture_status` ([`server.rs:5659`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5659)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:5659`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5659)) naming the old file in the
...
([`server.rs:7907`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7907)), and `--mcp-file-root` with
