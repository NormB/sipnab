...
1. **Off unless armed.** `allow_shutdown: bool`
   ...
   ([`server.rs:622`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L622)) and only set by `with_shutdown()`
   ([`server.rs:622`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L622)), which `servers.rs` calls only
