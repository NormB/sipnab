...
([`server.rs:5643`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5643)) writes a pcap, `export_audio`
([`server.rs:5691`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5691)) writes a WAV, `list_captures`
([`server.rs:5591`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5591)) reads a directory, and
`shutdown_server` ([`server.rs:6156`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6156)) ends the process.
...
- `DialogSummary.from_user` / `to_user`
  ...
  From/To URIs.
- `get_message` ([`server.rs:3476`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L3476)) returns the parsed
  message through `message_to_json_value`, headers and body included.
- `search_messages` ([`server.rs:3768`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L3768)) returns
  `snippet`, built as
...
`capture_status` ([`server.rs:4113`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4113)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:4113`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4113)) naming the old file in the
...
([`server.rs:6156`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6156)), and `--mcp-file-root` with
