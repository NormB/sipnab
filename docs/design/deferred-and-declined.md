...
([`server.rs:7109`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7109)) writes a pcap, `export_audio`
([`server.rs:7141`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7141)) writes a WAV, `list_captures`
([`server.rs:7019`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7019)) reads a directory, and
`shutdown_server` ([`server.rs:7621`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7621)) ends the process.
...
- `DialogSummary.from_user` / `to_user`
  ...
  From/To URIs.
- `get_message` ([`server.rs:4786`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4786)) returns the parsed
  message through `message_to_json_value`, headers and body included.
- `search_messages` ([`server.rs:5153`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5153)) returns
  `snippet`, built as
...
`capture_status` ([`server.rs:5523`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5523)) would keep naming
...
1. **`CaptureContext` must become shared, not per-session.** It is a plain
   ...
   ([`server.rs:5523`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5523)) naming the old file in the
...
([`server.rs:7621`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L7621)), and `--mcp-file-root` with
