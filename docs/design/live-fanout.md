...
- The help text, [`cli.rs:1447-1453`](https://github.com/NormB/sipnab/blob/main/src/cli.rs#L1447-L1453): *"CPU cores for OFFLINE
  ...
  path regardless."*
- `cores_ignored_warning` ([`bootstrap.rs:3012`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3012)),
...
- `cores_warning_is_the_exact_complement_of_the_paths_that_honor_it`
  ([`bootstrap.rs:3834`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3834)), which asserts the warning
...
`capture_health` MCP response ([`server.rs:8275`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L8275)),
...
- **Is `immediate_mode` right for N sockets?** `immediate_mode_for`
  ([`bootstrap.rs:2531`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L2531)) returns true only for the
