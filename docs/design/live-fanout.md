...
- The help text, [`cli.rs:1447-1453`](https://github.com/NormB/sipnab/blob/main/src/cli.rs#L1447-L1453): *"CPU cores for OFFLINE
  ...
  path regardless."*
- `cores_ignored_warning` ([`bootstrap.rs:4058`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L4058)),
...
- `cores_warning_is_the_exact_complement_of_the_paths_that_honor_it`
  ([`bootstrap.rs:4894`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L4894)), which asserts the warning
...
`capture_health` MCP response ([`server.rs:8385`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L8385)),
...
- **Is `immediate_mode` right for N sockets?** `immediate_mode_for`
  ([`bootstrap.rs:3497`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3497)) returns true only for the
