...
- The help text, [`cli.rs:1447-1453`](https://github.com/NormB/sipnab/blob/main/src/cli.rs#L1447-L1453): *"CPU cores for OFFLINE
  ...
  path regardless."*
- `cores_ignored_warning` ([`bootstrap.rs:2968`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L2968)),
...
- `cores_warning_is_the_exact_complement_of_the_paths_that_honor_it`
  ([`bootstrap.rs:3790`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3790)), which asserts the warning
...
`capture_health` MCP response ([`server.rs:8226`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L8226)),
...
2. **`StreamStore::reassociate_all` links streams to dialogs globally**
   ([`stream_store.rs:1787`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1787)), because SDP and RTP
...
- **Is `immediate_mode` right for N sockets?** `immediate_mode_for`
  ([`bootstrap.rs:2487`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L2487)) returns true only for the
