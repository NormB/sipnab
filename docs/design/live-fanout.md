...
- The help text, [`cli.rs:1447-1453`](https://github.com/NormB/sipnab/blob/main/src/cli.rs#L1447-L1453): *"CPU cores for OFFLINE
  ...
  path regardless."*
- `cores_ignored_warning` ([`bootstrap.rs:3673`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3673)),
...
- `cores_warning_is_the_exact_complement_of_the_paths_that_honor_it`
  ([`bootstrap.rs:4509`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L4509)), which asserts the warning
