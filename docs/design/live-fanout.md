...
- The help text, [`cli.rs:1447-1453`](https://github.com/NormB/sipnab/blob/main/src/cli.rs#L1447-L1453): *"CPU cores for OFFLINE
  ...
  path regardless."*
- `cores_ignored_warning` ([`bootstrap.rs:2293`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L2293)),
...
`capture_health` MCP response ([`server.rs:6141`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L6141)),
