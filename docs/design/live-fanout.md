...
- The help text, [`cli.rs:1447-1453`](https://github.com/NormB/sipnab/blob/main/src/cli.rs#L1447-L1453): *"CPU cores for OFFLINE
  ...
  path regardless."*
- `cores_ignored_warning` ([`bootstrap.rs:3509`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3509)),
...
- **Is `immediate_mode` right for N sockets?** `immediate_mode_for`
  ([`bootstrap.rs:3028`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3028)) returns true only for the
