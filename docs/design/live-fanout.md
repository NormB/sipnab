...
- The help text, [`cli.rs:1447-1453`](https://github.com/NormB/sipnab/blob/main/src/cli.rs#L1447-L1453): *"CPU cores for OFFLINE
  ...
  path regardless."*
- `cores_ignored_warning` ([`bootstrap.rs:3652`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3652)),
...
- `cores_warning_is_the_exact_complement_of_the_paths_that_honor_it`
  ([`bootstrap.rs:4488`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L4488)), which asserts the warning
...
`capture_health` MCP response ([`server.rs:8151`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L8151)),
...
- **Is `immediate_mode` right for N sockets?** `immediate_mode_for`
  ([`bootstrap.rs:3171`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3171)) returns true only for the
