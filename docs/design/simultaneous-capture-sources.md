...
([`src/capture/file.rs:310`](https://github.com/NormB/sipnab/blob/main/src/capture/file.rs#L310)), `capture_hep` ([`src/capture/hep.rs:2497`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L2497)), the
...
`IdleWatch` ([`src/capture/hep.rs:1738`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L1738)) papers over with a log line after a
