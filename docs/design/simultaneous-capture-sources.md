...
tuples. `process_packet` ([`src/pipeline.rs:2353`](https://github.com/NormB/sipnab/blob/main/src/pipeline.rs#L2353)) feeds each one to `link_to_dialog_with_sdp`
([`src/rtp/stream_store.rs:1160`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1160)), which lands in `link_endpoint_with_ptime`
([`src/rtp/stream_store.rs:1268`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1268)). That function does two things:
...
1. `remember_sdp_endpoint` ([`src/rtp/stream_store.rs:1376`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1376)) records
   ...
   *later* resolves at creation through `resolve_from_sdp`
   ([`src/rtp/stream_store.rs:1438`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1438)), called from [`src/rtp/stream_store.rs:507`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L507).
...
([`src/rtp/stream_store.rs:1604`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1604)): *"An ICMP error about media carries no
...
so `parse_hep_v2` ([`src/capture/hep.rs:1246`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L1246)) stamps local receive time, and v3
...
`link_endpoint_with_ptime` ([`src/rtp/stream_store.rs:1268`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1268))
restarts the estimator and records where, so `measured_jitter_ms`
([`src/rtp/stream_store.rs:1087`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1087)) withholds the figure until it
...
`IdleWatch` ([`src/capture/hep.rs:1636`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L1636)) papers over with a log line after a
...
`cores_ignored_warning` ([`src/app/bootstrap.rs:3012`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3012)) already names both reasons a
...
(`cores_ignored_warning`, [`src/app/bootstrap.rs:3012`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3012)), `-I` beating `-d` warns
...
2. Match on **both** endpoints of a stream's socket pair, not just the
   ...
   thing — `resolve_from_sdp` ([`src/rtp/stream_store.rs:1438`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1438)) tries `key.src`
