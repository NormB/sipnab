...
([`src/capture/file.rs:310`](https://github.com/NormB/sipnab/blob/main/src/capture/file.rs#L310)), `capture_hep` ([`src/capture/hep.rs:2371`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L2371)), the
...
([`src/rtp/stream_store.rs:1124`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1124)), which lands in `link_endpoint_with_ptime`
...
1. `remember_sdp_endpoint` ([`src/rtp/stream_store.rs:1340`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1340)) records
   `(addr, port) -> SdpEndpoint { call_id, rtpmap, ptime }`, so a stream created
   *later* resolves at creation through `resolve_from_sdp`
   ([`src/rtp/stream_store.rs:1402`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1402)), called from [`src/rtp/stream_store.rs:507`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L507).
...
([`src/rtp/stream_store.rs:1568`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1568)): *"An ICMP error about media carries no
...
([`src/rtp/stream_store.rs:1051`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1051)) withholds the figure until it
...
`IdleWatch` ([`src/capture/hep.rs:1612`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L1612)) papers over with a log line after a
...
`cores_ignored_warning` ([`src/app/bootstrap.rs:2874`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L2874)) already names both reasons a
...
(`cores_ignored_warning`, [`src/app/bootstrap.rs:2874`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L2874)), `-I` beating `-d` warns
...
2. Match on **both** endpoints of a stream's socket pair, not just the
   ...
   thing — `resolve_from_sdp` ([`src/rtp/stream_store.rs:1402`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1402)) tries `key.src`
