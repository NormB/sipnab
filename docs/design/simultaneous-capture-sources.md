...
([`src/capture/file.rs:310`](https://github.com/NormB/sipnab/blob/main/src/capture/file.rs#L310)), `capture_hep` ([`src/capture/hep.rs:2463`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L2463)), the
...
so `parse_hep_v2` ([`src/capture/hep.rs:1299`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L1299)) stamps local receive time, and v3
...
`IdleWatch` ([`src/capture/hep_roster.rs:164`](https://github.com/NormB/sipnab/blob/main/src/capture/hep_roster.rs#L164)) papers over with a log line after a
