...
`cores_ignored_warning` ([`src/app/bootstrap.rs:2968`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L2968)) already names both reasons a
...
(`cores_ignored_warning`, [`src/app/bootstrap.rs:2968`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L2968)), `-I` beating `-d` warns
