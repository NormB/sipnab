...
`launch` ([`src/app/bootstrap.rs:1682`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L1682)) takes the same singular `Option`. Four
...
- `Packet::interface` ([`src/capture/packet.rs:502`](https://github.com/NormB/sipnab/blob/main/src/capture/packet.rs#L502)) is an `Arc<str>` naming the
  ...
  ([`src/capture/hep_roster.rs:183`](https://github.com/NormB/sipnab/blob/main/src/capture/hep_roster.rs#L183)) and `hep_to_packet` ([`src/capture/hep.rs:134`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L134)).
...
needs. `start_multi_capture` ([`src/capture/native.rs:673`](https://github.com/NormB/sipnab/blob/main/src/capture/native.rs#L673)) validates the device
...
from the local kernel (`pcap_ts_to_chrono`, [`src/capture/live.rs:1004`](https://github.com/NormB/sipnab/blob/main/src/capture/live.rs#L1004)). Two
...
so `parse_hep_v2` ([`src/capture/hep.rs:1250`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L1250)) stamps local receive time, and v3
...
`link_endpoint_with_ptime` ([`src/rtp/stream_store.rs:1339`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1339))
restarts the estimator and records where, so `measured_jitter_ms`
([`src/rtp/stream_store.rs:1158`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream_store.rs#L1158)) withholds the figure until it
...
([`src/sip/dialog.rs:124`](https://github.com/NormB/sipnab/blob/main/src/sip/dialog.rs#L124)), whose `first_frame` field sits at line 148, and `RtpStream` ([`src/rtp/stream.rs:388`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream.rs#L388)) carries the same field at line 323
carry it downstream.
...
blocks at the cap ([`src/capture/channel.rs:289`](https://github.com/NormB/sipnab/blob/main/src/capture/channel.rs#L289) onward) and both producers draw
...
`fold_stats` ([`src/capture/live.rs:953`](https://github.com/NormB/sipnab/blob/main/src/capture/live.rs#L953)) and reported at
...
`cores_ignored_warning` ([`src/app/bootstrap.rs:3841`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3841)) already names both reasons a
...
(`cores_ignored_warning`, [`src/app/bootstrap.rs:3841`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3841)), `-I` beating `-d` warns
...
HEP listener keeps one per SENDER in its sender roster (`RosterState`,
[`src/capture/hep_roster.rs`](https://github.com/NormB/sipnab/blob/main/src/capture/hep_roster.rs)), because a listener is a fan-in and one
...
- **Does OpenSIPS mirror RTCP over HEP in practice?** `HepProtocol`
  ([`src/capture/hep.rs:865`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L865)) parses protocol type 5 as RTCP, and SRC1 says such a
