...
`launch` ([`src/app/bootstrap.rs:1708`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L1708)) takes the same singular `Option`. Four
...
`cores_ignored_warning` ([`src/app/bootstrap.rs:3722`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3722)) already names both reasons a
...
(`cores_ignored_warning`, [`src/app/bootstrap.rs:3722`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3722)), `-I` beating `-d` warns
