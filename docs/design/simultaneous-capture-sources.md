...
`launch` ([`src/app/bootstrap.rs:1681`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L1681)) takes the same singular `Option`. Four
...
`cores_ignored_warning` ([`src/app/bootstrap.rs:3554`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3554)) already names both reasons a
...
(`cores_ignored_warning`, [`src/app/bootstrap.rs:3554`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3554)), `-I` beating `-d` warns
