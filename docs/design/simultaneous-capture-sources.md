...
`cores_ignored_warning` ([`src/app/bootstrap.rs:3175`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3175)) already names both reasons a
...
(`cores_ignored_warning`, [`src/app/bootstrap.rs:3175`](https://github.com/NormB/sipnab/blob/main/src/app/bootstrap.rs#L3175)), `-I` beating `-d` warns
