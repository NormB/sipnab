...
2. **The permit is a parameter of every send.** Five signatures take it —
   ...
   `BatchRunner::new` ([`batch.rs:2204`](https://github.com/NormB/sipnab/blob/main/src/app/batch.rs#L2204)) by value, and the
...
- `HepSender::send` ([`hep.rs:3444`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L3444)) builds a HEP v3
