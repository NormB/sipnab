...
2. **The permit is a parameter of every send.** Five signatures take it —
   ...
   `BatchRunner::new` ([`batch.rs:2016`](https://github.com/NormB/sipnab/blob/main/src/app/batch.rs#L2016)) by value, and the
...
- `HepSender::send` ([`hep.rs:2148`](https://github.com/NormB/sipnab/blob/main/src/capture/hep.rs#L2148)) builds a HEP v3
