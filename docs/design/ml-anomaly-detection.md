...
([`src/sip/dialog.rs:274`](https://github.com/NormB/sipnab/blob/main/src/sip/dialog.rs#L274))
...
([`src/mcp/server.rs:3353`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L3353))
