...
| `stats` | Mirrors `GET /v1/stats` from `output::api::get_stats` ([`src/output/api.rs:3437`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs#L3437)) |

| Phase 8 infra | Reuses |
|---|---|
| Bind address parsing | `output::api::parse_bind_addr` ([`src/output/api.rs:690`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs#L690)) |
...
| WebSocket / SSE Router mounting | Extend `output::api::build_router` ([`src/output/api.rs:614`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs#L614)) with new routes; reuse the existing `guard()` middleware |
