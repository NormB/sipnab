...
| `stats` | Mirrors `GET /v1/stats` from `output::api::get_stats` ([`src/output/api.rs:2664`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs#L2664)) |

| Phase 8 infra | Reuses |
|---|---|
| Bind address parsing | `output::api::parse_bind_addr` ([`src/output/api.rs:603`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs#L603)) |
...
| WebSocket / SSE Router mounting | Extend `output::api::build_router` ([`src/output/api.rs:541`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs#L541)) with new routes; reuse the existing `guard()` middleware |
