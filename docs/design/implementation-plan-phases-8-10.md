...
| `stats` | Mirrors `GET /v1/stats` from `output::api::get_stats` ([`src/output/api.rs:3166`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs#L3166)) |

| Phase 8 infra | Reuses |
|---|---|
| Bind address parsing | `output::api::parse_bind_addr` ([`src/output/api.rs:671`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs#L671)) |
...
| WebSocket / SSE Router mounting | Extend `output::api::build_router` ([`src/output/api.rs:596`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs#L596)) with new routes; reuse the existing `guard()` middleware |
