...
| `stats` | Mirrors `GET /v1/stats` from `output::api::get_stats` ([`src/output/api.rs:2377`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs#L2377)) |
...
| WebSocket / SSE Router mounting | Extend `output::api::build_router` ([`src/output/api.rs:511`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs#L511)) with new routes; reuse the existing `guard()` middleware |
