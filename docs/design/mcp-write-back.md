...
56 tools ([`server.rs`](../../src/mcp/server.rs), `#[tool(` at `:938` through
...
- `get_message` ([`server.rs:4866`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4866)) returns headers and
  body.
- `search_messages` ([`server.rs:5161`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5161)) returns a
