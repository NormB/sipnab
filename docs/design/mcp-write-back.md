...
55 tools ([`server.rs`](../../src/mcp/server.rs), `#[tool(` at `:938` through
...
- `get_message` ([`server.rs:4788`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4788)) returns headers and
  body.
- `search_messages` ([`server.rs:5081`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5081)) returns a
...
([`server.rs:727`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L727)) accepts a bare filename and rejects
...
- It reaches the filesystem through `resolve_in_root`
  ([`server.rs:727`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L727)) exactly as `export_capture` and
