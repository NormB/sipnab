...
64 tools ([`server.rs`](../../src/mcp/server.rs), `#[tool(` at `:938` through
...
- `get_message` ([`server.rs:4746`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4746)) returns headers and
  body.
- `search_messages` ([`server.rs:5113`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5113)) returns a
...
([`server.rs:781`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L781)) accepts a bare filename and rejects
...
- It reaches the filesystem through `resolve_in_root`
  ([`server.rs:781`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L781)) exactly as `export_capture` and
