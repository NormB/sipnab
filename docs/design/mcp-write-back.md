...
- `get_message` ([`server.rs:4305`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4305)) returns headers and
  body.
- `search_messages` ([`server.rs:4597`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4597)) returns a
...
([`server.rs:608`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L608)) accepts a bare filename and rejects
...
- It reaches the filesystem through `resolve_in_root`
  ([`server.rs:608`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L608)) exactly as `export_capture` and
