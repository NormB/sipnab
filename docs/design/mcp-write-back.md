...
- `get_message` ([`server.rs:4942`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L4942)) returns headers and
  body.
- `search_messages` ([`server.rs:5356`](https://github.com/NormB/sipnab/blob/main/src/mcp/server.rs#L5356)) returns a
