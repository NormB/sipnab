...
- **Feature gate:** every item lives behind `#[cfg(feature = "vcon")]`.
  ...
  [`src/app/batch.rs:5949`](https://github.com/NormB/sipnab/blob/main/src/app/batch.rs#L5949), and a new entry point needs the same pairing or the
...
- Modify: [`src/app/batch.rs:5949`](https://github.com/NormB/sipnab/blob/main/src/app/batch.rs#L5949) (`export_vcon`)
