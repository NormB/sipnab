...
- **Feature gate:** every item lives behind `#[cfg(feature = "vcon")]`.
  ...
  [`src/app/batch.rs:5916`](https://github.com/NormB/sipnab/blob/main/src/app/batch.rs#L5916), and a new entry point needs the same pairing or the
...
- Modify: [`src/app/batch.rs:5916`](https://github.com/NormB/sipnab/blob/main/src/app/batch.rs#L5916) (`export_vcon`)
