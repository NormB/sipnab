...
write locks. A HEP listener's sender roster
...
a refused sender's packets and counts them as untracked. The refused-source
...
[`src/analysis.rs`](../../src/analysis.rs) as forbidden outright. The writer
