...
// export_vcon { "call_id": "1-1966@10.0.2.20" }
{
  ...
  "attachments": [
    ...
    },
    {
      ...
      "encoding": "json",
      "body": {
        "note": "Produced by sipnab 0.5.126 on node capture-01. sipnab OBSERVED this dialog and took no part in it: ... sipnab read 852 frame(s) for this capture. No omissions recorded: every message sipnab held for this dialog is in this container. A capture-level analysis ran and ranked no blind spots.",
        "node": "capture-01",
