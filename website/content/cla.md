...
description = "sipnab requires every contributor to sign a Contributor License Agreement (CLA) before their pull request can be merged. Read the agreement and sign it here."
template = "page.html"
+++

Before your first pull request to **sipnab** can be merged, you need to sign the
sipnab Individual Contributor License Agreement (CLA). It is a one-time step: it
covers all of your past, present and future contributions, and you keep full
ownership of your work.

Signing is handled by [CLA Assistant](https://cla-assistant.io/): when you open a
pull request, a bot checks whether you have signed and, if not, leaves a comment
with a link. You sign in the browser with your GitHub account.

<p>
<a class="btn btn-primary" href="https://cla-assistant.io/NormB/sipnab" target="_blank" rel="noopener noreferrer">Sign the CLA &rarr;</a>
</p>

---

## SIPNAB Individual Contributor License Agreement

Thank you for your interest in contributing to open source software projects
("Projects") made available by Norm Brandinger ("SIPNAB"). This Individual
...
works of authorship that you submit or have submitted, in any form and in any
manner, to SIPNAB in respect of any of the Projects (collectively
"Contributions"). If you have any questions respecting this Agreement, please
contact n.brandinger@gmail.com.
...
**Copyright License.** You hereby grant, and agree to grant, to SIPNAB a
non-exclusive, perpetual, irrevocable, worldwide, fully-paid, royalty-free,
transferable copyright license to reproduce, prepare derivative works of,
publicly display, publicly perform, and distribute your Contributions and such
derivative works, with the right to sublicense the foregoing rights through
multiple tiers of sublicensees.

**Patent License.** You hereby grant, and agree to grant, to SIPNAB a
non-exclusive, perpetual, irrevocable, worldwide, fully-paid, royalty-free,
transferable patent license to make, have made, use, offer to sell, sell,
...
your Contributions alone or by combination of your Contributions with the
Project to which such Contributions were submitted, with the right to sublicense
...
to your Contributions for the benefit of SIPNAB, its assigns, and their
...
waived all of their right, title or interest in or to your Contributions.
...
**No Obligation.** You acknowledge that SIPNAB is under no obligation to use or
...
discretion of SIPNAB or its authorized delegates.
...
giving effect to its principles or rules regarding conflicts of laws, other than
such principles directing application of New Jersey law. The parties hereby
submit to venue in, and jurisdiction of the courts located in New Jersey, United
States of America for purposes relating to this Agreement. In the event that any
of the provisions of this Agreement shall be held by a court or other tribunal
of competent jurisdiction to be unenforceable, the remaining portions hereof
shall remain in full force and effect.

**Assignment.** You agree that SIPNAB may assign this Agreement, and all of its
