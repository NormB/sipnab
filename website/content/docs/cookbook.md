...
+++
<!-- Generated by scripts/build-site-cookbook.py from docs/examples.md — do not edit. Edit the source page and re-run the script; cookbook_mirror_is_current fails if this file is stale. -->
...
A ready-to-deploy systemd unit lives at `contrib/observability/sipnab-hep.service` — see [Remote-sipnab deployment](@/docs/install.md) in the install guide.
