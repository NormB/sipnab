...
Manual download with checksum verification (replace `<version>` with the latest, e.g. 0.5.3):
...
sipnab 0.5.3 (c9620a5f) features: native,tui,audio,tls,hep,api,mcp,mcp-http
