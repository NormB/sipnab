...
[mcp.md § Client cookbook](@/docs/mcp-deploy.md#connect-a-specific-client) drive the same tools
...
[mcp.md § Security model](@/docs/mcp-protocol.md#security-model)):
...
[mcp.md § Troubleshooting](@/docs/mcp-deploy.md#troubleshooting). The
[raw HTTP test](@/docs/mcp-deploy.md#test-the-http-wire-by-hand) there is a working curl carrying every
required header.
...
[The MCP walkthrough](@/docs/mcp-deploy.md) covers this end to end, including an
