...
+++
<!-- Generated by scripts/build-site-pages.py from docs/rtpengine.md — do not edit. Edit the source page and re-run the script; site_pages_mirror_is_current fails if this file is stale. -->
...
- [Encapsulations](@/docs/encapsulations.md) — HEP and the other wrappers sipnab reads
- [Capture SIP over TLS](@/docs/tls-capture.md) — when encryption hides the signaling
- [MCP tools](@/docs/mcp-tools.md) — the agent-facing surface over these results
