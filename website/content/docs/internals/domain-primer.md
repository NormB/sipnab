...
| `cumulative_lost` has no sign bit | A 24-bit **signed** field zero-extended: net-duplicate streams reported ~16.7M lost packets | Sign extension in [`rtcp.rs`](https://github.com/NormB/sipnab/blob/main/src/rtp/rtcp.rs), clamped at zero |
