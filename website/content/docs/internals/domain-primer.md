...
[`diagnose_media()`](https://github.com/NormB/sipnab/blob/main/src/rtp/diagnosis.rs) is where this is untangled:
...
| `cumulative_lost` is unsigned | A 24-bit **signed** field zero-extended: net-duplicate streams reported ~16.7M lost packets | Sign extension in [`rtcp.rs`](https://github.com/NormB/sipnab/blob/main/src/rtp/rtcp.rs), clamped at zero |
| Transit deltas can be unsigned | One reordered packet underflowed to a ~4.29e9 jitter spike | Signed `i32` delta in [`stream.rs`](https://github.com/NormB/sipnab/blob/main/src/rtp/stream.rs) |
