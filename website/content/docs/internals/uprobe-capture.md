...
[`bpf.rs`](https://github.com/NormB/sipnab/blob/main/src/capture/uprobe/bpf.rs) with that in mind. The lines the
...
[`tests/bpf_load_verification_test.rs`](https://github.com/NormB/sipnab/blob/main/tests/bpf_load_verification_test.rs) does, with the real message from a real
