...
> ([`batch.rs`](https://github.com/NormB/sipnab/blob/main/src/app/batch.rs)).
>
...
[`process-isolation-and-hot-path-cost.md` section 4, "Verdict"](https://github.com/NormB/sipnab/blob/main/docs/design/process-isolation-and-hot-path-cost.md#4-verdict).
...
[`rtcp_one_rule_test`](https://github.com/NormB/sipnab/blob/main/tests/rtcp_one_rule_test.rs) fails on a second
...
walk in [`archive`](https://github.com/NormB/sipnab/blob/main/src/capture/archive/mod.rs) stops rather than evicts:
...
[`LruMap`](https://github.com/NormB/sipnab/blob/main/src/lru.rs)s: `MAX_SOURCE_ENTRIES` (10,000) sources in the
...
([`hep_roster.rs`](https://github.com/NormB/sipnab/blob/main/src/capture/hep_roster.rs)) holds two such maps. The
...
[`MAX_SAMPLE_SECONDS`](https://github.com/NormB/sipnab/blob/main/src/output/runtime.rs) caps that window at 30
...
[`api.rs`](https://github.com/NormB/sipnab/blob/main/src/output/api.rs) fail the **build** if that derivation ever
...
what was on the wire. [Section 2 of the deferred-and-declined record](https://github.com/NormB/sipnab/blob/main/docs/design/deferred-and-declined.md#2-write-back-mcp-tools)
...
**Enforced by.** [`NoteText`](https://github.com/NormB/sipnab/blob/main/src/annotate/mod.rs) keeps its text in a
...
[`src/analysis.rs`](https://github.com/NormB/sipnab/blob/main/src/analysis.rs) as forbidden outright.
