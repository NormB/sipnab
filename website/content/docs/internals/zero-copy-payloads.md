+++
title = "Zero-Copy Payloads"
weight = 8
description = "The bytes::Bytes spine from capture to output — including a performance claim the page itself refutes."
+++
<!-- Generated by scripts/build-site-internals.py from docs/internals/zero-copy-payloads.md — do not edit. Edit the source page and re-run the script; dev_docs_drift_test fails if this file is stale. -->
