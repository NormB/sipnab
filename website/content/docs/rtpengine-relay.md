+++
title = "Add rtpengine to an OpenSIPS voice stack"
weight = 44
description = "Build rtpengine and OpenSIPS, anchor every call's media on the relay, prove it with a test call, and operate it. No sipnab involved."
+++
<!-- Generated by scripts/build-site-pages.py from docs/rtpengine-relay.md — do not edit. Edit the source page and re-run the script; site_pages_mirror_is_current fails if this file is stale. -->
...
[Let sipnab name rtpengine's media](@/docs/rtpengine-sipnab.md) adds sipnab beside
it.
