+++
title = "Look up a SIP parameter"
weight = 23
description = "Every SIP URI parameter, header-field parameter and option tag in the IANA registry, with the RFC that defines it."

[extra]
lead_in_body = true
+++
<!-- Generated by scripts/build-site-pages.py from docs/sip-parameters.md — do not edit. Edit the source page and re-run the script; site_pages_mirror_is_current fails if this file is stale. -->
...
[sip-response-codes.md](@/docs/sip-response-codes.md) and [sip-methods.md](@/docs/sip-methods.md)
