...
[`clients/python/`](https://github.com/NormB/sipnab/blob/main/clients/python), [`clients/go/`](https://github.com/NormB/sipnab/blob/main/clients/go) or
[`clients/javascript/`](https://github.com/NormB/sipnab/blob/main/clients/javascript), and CI compiles every one and runs
...
reference is in [mcp-tools.md](@/docs/mcp-tools.md#why-the-call-ended). sipnab omits
...
- **No media by default — but `--retain-audio` changes that.** Without it the
  ...
  retention and disclosure purpose. [vCon](@/docs/vcon.md) documents the same
  behavior.
...
[Output formats](@/docs/output-formats.md) lists every difference. This is not a
...
reach](@/docs/install.md#which-capture-backends-an-artifact-can-reach).
...
[Archives](@/docs/cli.md#archives)). A client may add one in the
...
[deferred-and-declined record](https://github.com/NormB/sipnab/blob/main/docs/design/deferred-and-declined.md#2-write-back-mcp-tools)
