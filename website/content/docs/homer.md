+++
title = "Add Homer to an OpenSIPS voice stack"
weight = 46
description = "Run heplify-server, homer-app and PostgreSQL, have OpenSIPS send every call to Homer over HEP, and find the call. No sipnab involved."
+++
<!-- Generated by scripts/build-site-pages.py from docs/homer.md — do not edit. Edit the source page and re-run the script; site_pages_mirror_is_current fails if this file is stale. -->
...
[Connect sipnab to Homer](@/docs/homer-sipnab.md) adds sipnab as a second receiver
