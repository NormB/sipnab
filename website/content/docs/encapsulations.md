...
weight = 25
description = "Which link types, EtherTypes and tunnels sipnab can read a SIP dialog out of, which it cannot, and what it reports when a frame will not decode."
+++
